          ...
          <Row>
            <Col md={12}>
              <div className="d-flex justify-content-center align-items-center mt-lg-4 mt-3 gap-3">
                <a href="#" aria-label="Visit our Twitter profile" title="x-twitter" target="_blank" rel="noopener noreferrer"><img src="/assets/images/xTwitter-icon.svg" alt="x-Twitter" className="img-fluid" /></a>
                <a href="#" aria-label="Visit our Facebook profile" title="facebook" target="_blank" rel="noopener noreferrer"><img src="/assets/images/facebook-icon.svg" alt="facebook" className="img-fluid" /></a>
                <a href="#" aria-label="Visit our Instagram profile" title="instagram" target="_blank" rel="noopener noreferrer"><img src="/assets/images/instagram-icon.svg" alt="instagram" className="img-fluid" /></a>
                <a href="#" aria-label="Visit our Youtube profile" title="Youtube" target="_blank" rel="noopener noreferrer"><img src="/assets/images/youtube-icon.svg" alt="Youtube" className="img-fluid" /></a>
              </div>
            </Col>
          </Row>
          <Row>
